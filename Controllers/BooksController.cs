...
namespace WebAppDemo3.Controllers
{
    public class BooksController : Controller
    {
       ...
       // [Authorize(Roles = "Admin")]
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Author,Description,Image,Price,PublishedDate,CategoryId")] Book book)
        {
       ...
       // [Authorize(Roles = "Admin")]
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Author,Description,Image,Price,PublishedDate,CategoryId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
      ...
      //  [Authorize(Roles = "Admin")]
        ...
        {
            var books = _context.Book.Where(x => x.Title.Contains(searchString)).ToList();
